...
function loadBooks() {
    // Replace the following line with an alternative mechanism to fetch book data
    allBooks = []; // Replace this with your book data fetching logic
    allBooks = allBooks.filter(book => book.shouldDisplay); // Only the ones that should be displayed
